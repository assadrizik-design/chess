...
const rawPuzzles = [
  ...
  { title: "المستوى 16: السلم القاتل المزدوج", fen: "8/8/8/8/8/5k2/5p1p/4R2K w - - 0 1", moves: ["Re3+", "Kg4", "Re4#"] }, // Wait, check this one
  { title: "المستوى 17: تشتيت البصيرة", fen: "1r4k1/p4ppp/8/8/8/8/q4PPP/1R4K1 w - - 0 1", moves: ["Rxb8#"] }, // Actually mate in 1
  ...
  { title: "المستوى 23: الرخ الجامح", fen: "r1b2r1k/1p1pR1pp/p1qP4/5p2/8/1Q4R1/PP3PPP/6K1 w - - 0 1", moves: ["Rexg7", "Qc1+", "Qd1", "Qxd1#"] }, // this has white getting mated? wait!
  { title: "المستوى 24: الإبرة المخيفة", fen: "r1bqk2r/pppp1ppp/2n2n2/4p3/1bB1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 1", moves: ["Nxe5", "Bxd1", "Bxf7+", "Ke7", "Nd5#"] },
  { title: "المستوى 25: استدراج النهاية", fen: "k7/8/p1K5/8/8/8/8/7R w - - 0 1", moves: ["Rh8+", "Ka7", "Rh7+", "Ka8", "Kb6", "a5", "Rh8#"] }, 
...
fs.writeFileSync('/app/applet/generated_puzzles.json', JSON.stringify(finalPuzzles, null, 2));
